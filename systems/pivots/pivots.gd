...
var pivots: Dictionary[String, Pivot] = {}  # Dictionary to hold all pivot nodes
...
## Initializes the pivots dictionary.
func init() -> void:    
    var pivot_id: int = 0
...
## Sets the anchor of a node to a pivot.
